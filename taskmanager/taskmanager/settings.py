...
# SECURITY WARNING: keep the secret key used in production secret!                          позволяет дать доступ к сайту (взлому)           
SECRET_KEY = 'django-insecure-$bbprhs(wc(+6^bc)@&)88^(-u*ckg*-iju)f1x4i85hi9o6pe'
...
TEMPLATES = [
    {
        ...
        'DIRS': [],                                                                     #указыватся дирректории статичных файлов
        'APP_DIRS': True,
        'OPTIONS': {
            'context_processors': [
...
DATABASES = {
    'default': {
        'ENGINE': 'django.db.backends.sqlite3',                                                 #можно указать любую база данных. по умолчанию sqlite3
...
LANGUAGE_CODE = 'ru-ru'                                                                          #язык который используется на всем сайте было en-us
